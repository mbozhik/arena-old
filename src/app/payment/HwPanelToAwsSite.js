...
const HwPanelToAwsSite = () => {
    ...
    useEffect(() => {
        ...
        axios.get(ApiUrl.SendApiUrl + apiKey + '/').then((response) => {
                ...
                <div className="flex justify-content-center">
                    <div className=" w-full bg-white border-none shadow-sm mt-lg-4 mt-5">
                        <div className="p-lg-4 p-5">
                            <h6 ><span className='font-semibold'>Name: </span><span className="text-primary">{studentName}</span></h6>
                            <h6><span className='font-semibold'>Email:</span> <span className="text-primary">{studentEmail}</span></h6>
                            <h6> <span className='font-semibold'>Phone: </span><span className="text-primary">{studentPhone}</span></h6>
                        </div>
                    </div>
                </div>
                {onStudentRedirect()}
