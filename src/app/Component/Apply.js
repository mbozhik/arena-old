...
const Apply = (e) => {
  ...
  let yearsArray = Array.from({length: 70}, (_, index) => startYear + index).reverse()
      ...
      <form onSubmit={(e) => RegistationSucess(e)} className="relative shadow-sm">
        ...
        <div className="grid mt-3 gap-y-4">
          <div className="grid grid-cols-6 gap-x-2">
            <div className="w-full col-span-6 pt-1 mt-2 md:col-span-3 md:mt-0">
              <TextField
                fullWidth
                required
                name="student_name"
            ...
            <div className="w-full col-span-6 pt-1 md:col-span-3 ">
              <PhoneInput
                value={validNumber}
          ...
          <div className="grid grid-cols-6 gap-x-2">
            ...
            <div className="grid w-full grid-cols-2 col-span-6 mt-2 md:col-span-3 md:mt-0 gap-x-2">
              <div className="pt-1 ">
                <TextField
                  fullWidth
                  required
            ...
            <div className="w-full col-span-6">
              <div className="grid grid-cols-6 gap-x-2">
                <div className="w-full md:col-span-3 col-span-6 mt-5 md:mt-0 border-b border-[#B0BEC5] grid grid-cols-3 gap-2 px-4 relative inputDateP ">
                  <span className="">Date Of Birth *{/* <span className="text-red-400">*</span> */}</span>

                  <CustomDaySelect year={year} month={month} setBirth_date={setBirth_date} setDay={setDay} />
                  ...
                  <CustomMonthSelect year={year} day={day} setMonth={setMonth} setBirth_date={setBirth_date} />
                  {/* <select
                    className="border border-[#B0BEC5] text-center p-1 rounded-md focus:outline-none"
                    id="Year"
                    onChange={(e) => {
                  ...
                  <CustomYearSelect month={month} day={day} setYear={setYear} setBirth_date={setBirth_date} />
                </div>
                <div className="w-full col-span-6 pt-1 mt-2 md:col-span-3 md:mt-0">
                  <TextField
                    fullWidth
          ...
          <div className="grid grid-cols-6 gap-x-2">
            ...
            <div className="relative w-full col-span-6 pt-1 mt-2 md:col-span-3 md:mt-0">
              <TextField
                fullWidth
                required
                select
                  ...
                  allcourse
                    ...
                    .map((x, index) => (
                      <MenuItem
                        ...
                        className="w-64 whitespace-normal sm:w-full"
                        sx={{
          ...
          <div className="flex items-center mb-1">
            {/* <input
              ...
              className="mr-2"
            /> */}
            <input type="checkbox" id="notRequired" checked={notRequired} onChange={handleCheckboxChange} className="mr-2" />
            <label htmlFor="notRequired" className="text-sm">
              Not Required
            </label>
          </div>
        ...
        <div className="flex justify-center py-5">
          <button type="submit" className={`px-8 py-3 ${pending ? 'bg-[#90bde0]' : 'bg-blue-500 hover:bg-blue-600'} text-white rounded-lg`} disabled={pending}>
            Submit
          </button>
        </div>
      </form>
