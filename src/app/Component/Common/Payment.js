...
export function PaymentModal() {
  ...
  return (
    ...
    <p className="text-[16px] font-[300] pt-10 pb-5 leading-[19px] text-center">you can pay via online and offline both. Online process via #Bkash #Nagad #Rocket <br/> #Western_Union #EBL.</p>
