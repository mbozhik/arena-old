...
export function ServiceCard() {
  return (
    <div className="grid">
      <div className="grid gap-4 mt-6 lg:grid-cols-4 md:grid-cols-2 ">
        <Fade direction="left">
          <Card className="relative grid 2xl:h-[40rem]  md:h-[35rem] h-[26rem] w-full max-w-[28rem] group  transition-all duration-350  items-end justify-center overflow-hidden text-center border-3 border-[#8444c8cc]">
            <CardHeader color="transparent" className="absolute inset-0 w-full h-full m-0 bg-center bg-cover rounded-none CyberService">
              <div
                className="absolute inset-0 w-full h-full to-bg-black-10 bg-gradient-to-t group-hover:from-black/100 from-black/90 via-black/80 group-hover:via-black/100"
              />
            </CardHeader>
            <CardBody className="absolute transition-all duration-700 ease-in-out  2xl:py-14 2xl:px-3 xl:px-2 xl:translate-y-60 2xl:translate-y-52 group-hover:translate-y-0">
              <Typography variant="h2" color="white" className="mb-6 font-bold leading-[1.5] text-white  2xl:text-3xl text-2xl   ">
                Cyber Security Consultancy
              </Typography>
              <Typography variant="paragraph" className="mb-4 font-semibold text-white transition-all duration-700 ease-in-out group-hover:w-full lg:opacity-0 group-hover:opacity-100 ">
        ...
        <Card className="relative grid 2xl:h-[40rem]  md:h-[35rem] h-[26rem] w-full max-w-[28rem] group  transition-all duration-350  items-end justify-center overflow-hidden text-center border-3 border-[#8444c8cc]">
          <CardHeader color="transparent" className="absolute inset-0 w-full h-full m-0 bg-center bg-cover rounded-none Sof">
            <div
              className="absolute inset-0 w-full h-full to-bg-black-10 bg-gradient-to-t group-hover:from-black/100 from-black/90 via-black/80 group-hover:via-black/100"
            />
          </CardHeader>
        ...
        <Card className="relative grid 2xl:h-[40rem]  h-[35rem]w-full max-w-[28rem] group  transition-all duration-350  items-end justify-center overflow-hidden text-center border-3 border-[#8444c8cc]">
          <CardHeader color="transparent" className="absolute inset-0 w-full h-full m-0 bg-center bg-cover rounded-none Net">
            <div
              className="absolute inset-0 w-full h-full to-bg-black-10 bg-gradient-to-t group-hover:from-black/100 from-black/90 via-black/80 group-hover:via-black/100"
            />
          </CardHeader>
        ...
        <Fade direction="right" duration={1000}>
          <Card className="relative grid 2xl:h-[40rem]  md:h-[35rem] h-[26rem] w-full max-w-[28rem] group  transition-all duration-350  items-end justify-center overflow-hidden text-center border-3 border-[#8444c8cc]">
            <CardHeader color="transparent" className="absolute inset-0 w-full h-full m-0 bg-center bg-cover rounded-none Mobile">
              <div
                className="absolute inset-0 w-full h-full to-bg-black-10 bg-gradient-to-t group-hover:from-black/100 from-black/90 via-black/80 group-hover:via-black/100"
              />
            </CardHeader>
            <CardBody className="absolute transition-all duration-700 ease-in-out 2xl:py-14 2xl:px-3 xl:px-2 xl:translate-y-60 2xl:translate-y-56 group-hover:translate-y-0 ">
              <Typography variant="h2" color="white" className="mb-6 font-bold leading-[1.5] text-white  2xl:text-3xl text-2xl   ">
