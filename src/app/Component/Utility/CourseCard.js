    ...
    <div className="grid">
      <div className="grid lg:grid-cols-4 gap-4 mt-6 ">
        <Link href="/cybersecurity">
          <div className="relative grid h-[40rem] w-full max-w-[28rem] group  transition-all duration-350  items-end justify-center overflow-hidden text-center border-3 border-[#8444c8cc]">
            <div
              color="transparent"
           ...
           w-full bg-gradient-to-t group-hover:from-black/100 from-black/90 via-black/80 group-hover:via-black/100"
            ...
            <article className=" py-14 px-6 md:px-12 absolute  translate-y-[300px] transition-all group-hover:translate-y-0 duration-700 ease-in-out ">
              ...
              <footer
                variant="h5"
                className="mb-4 text-[#FFA121] font-bold text-[20px]"
              >
                Tanjim AL Fahim
              </footer>
              <h2
