  ...
  return (
    <div className="grid">
      <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-4 mt-6 ">
        ...
        <Link href="/python">
          <div className="relative grid 2xl:h-[40rem]  md:h-[35rem] h-[26rem] w-full max-w-[28rem] group  transition-all duration-350  items-end justify-center overflow-hidden text-center border-3 border-[#8444c8cc]">
            <div
              color="transparent"
