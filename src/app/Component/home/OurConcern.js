...
const OurConcern = () => {
  return (
    <div className="container relative pb-5 mt-12 lg:mt-12 xl:pb-16 md:pb-10">
      <div className="">
        <h5 className="text-center text-[24px] xl:text-[32px] font-bold text-[#7BAADA] mb-2 font-poppins"> Our Valued Clients & Partners</h5>
        ...
        >
          {[img, img1, img2, img3, img4, img5, img6, img7, img8, img9, img10, img11].map((image, index) => (
            <SwiperSlide key={index} className="flex items-center justify-center">
              <Image sizes="100vw" src={image} className="w-16 rounded-md 2xl:h-24 2xl:w-28 xl:h-20 xl:w-24 md:h-16 md:w-20 h-14" alt={`ict-${index}`} width="auto" height="auto" />
            </SwiperSlide>
          ))}
        </Swiper>
      </div>
