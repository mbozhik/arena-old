        ...
        <div className="lg:px-20 md:px-5 lg:mt-16 md:mt-8 lg:h-[100vh] md:h-h[60vh] bg-[#EBE7F8]  ">
            <div className="grid grid-cols-6 h-full">
                ...
                <div className="md:col-span-4 ">
                    ...
                    <div className="md:-ml-10 flex gap-x-5 relative mb-5">
                        <article className="Events lg:w-5/12 md:w-6/12 xl:px-3 lg:px-1   lg:h-auto bg-white group p-3 rounded-md hover:scale-105 transition duration-500 ease-in-out">
                            ...
                            <Link href='cybersecurity'><h4 className="lg:font-semibold text-[#4aabff] text-[20px] pt-5 pb-2 group-hover:text-[#cbcb50]">{data &&  data[0]?.batch_schedule_name}</h4></Link>
                        ...
                        <article className="Events lg:w-5/12 md:w-6/12 xl:px-3 lg:px-1   lg:h-auto bg-white group p-3 rounded-md hover:scale-105 transition duration-500 ease-in-out">
                            ...
                            <Link href='python'><h4 className="lg:font-semibold text-[#4aabff] text-[20px] pt-5 pb-2 group-hover:text-[#cbcb50]">{data &&  data[1]?.batch_schedule_name}</h4></Link>
                            <p className="pt-5 lg:pb-10 md:pb-5">Admission going on for Cyber Security course by Arena Web Academy. The class will start on 21-01-2024. For admission: 01310333444</p>
                        </article>
