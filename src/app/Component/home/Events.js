                ...
                <div className="lg:col-span-4 ">
                    ...
                    <div className="lg:-ml-10 flex gap-x-5 relative">
                        <article className="Events w-2/6 lg:h-auto bg-white group p-3 rounded-md hover:scale-105 transition duration-500 ease-in-out">
                            ...
                            <p><addr className='font-semibold'>Date :</addr>{data &&  data[0]?.deadline_date_s}</p>
                            <p><addr className='font-semibold'>Time :</addr>
                             {
                        ...
                        <article className="Events w-2/6 lg:h-auto bg-white group p-3 rounded-md hover:scale-105 transition duration-500 ease-in-out">
                            <div className="flex justify-between py-6">
                            <p><addr className='font-semibold'>Date :</addr>{data &&  data[1]?.deadline_date_s}</p>
                            <p><addr className='font-semibold'>Time :</addr>
