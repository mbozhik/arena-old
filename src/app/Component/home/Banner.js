...
//     <div className="h-auto lg:h-[90vh] md:h-[60vh] relative overflow-hidden ">
//       <div className="BannerImg"></div>
//       <div className="absolute  left-0 bottom-0 h-full w-full lg:h-[80vh] md:h-[60vh]">
//     <div className="    md:flex  px-3 md:px-3 h-auto lg:h-[80vh] md:h-[60vh] ">
...
//         <h1 className="2xl:text-6xl   lg:text-5xl text-3xl  font-bold drop-shadow-lg text-[#00FFCA] mt-20 md:mt-0  w-full pl-2 lg:pl-0 ">Arena Web Security</h1>
...
//       <h3 className="uppercase text-yellow-400 2xl:text-3xl  lg:text-[26px] md:text:2xl  drop-shadow-md font-bold md:my-4 w-full pl-2 lg:pl-0 my-1">
//     {<Type/>}
//       </h3>
