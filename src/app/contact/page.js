...
const Contact = () => {
  return (
    <div className="container mx-auto">
      ...
      <div className=" lg:flex gap-10  py-5 lg:px-3 md:px-2 px-2" id="main">
        <div className="lg:w-1/2">
          <ContactForm />
        </div>
        <div className=" lg:w-1/2 mt-5 md:mt-0">
          <div className="h-[400px] xl:h-[500px] 2xl:h-[500px] ">
            <iframe
              className="border-0"
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3651.4921053577773!2d90.42471487599451!3d23.76548448819581!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b9998b8a324f%3A0xc7e89d05a8adc2e1!2sArena%20Web%20Security%20-%20The%20Hacker&#39;s%20Arena!5e0!3m2!1sen!2sbd!4v1685432813512!5m2!1sen!2sbd"
              title="map"
              height="100%"
              width="100%"
              allowfullscreen=""
